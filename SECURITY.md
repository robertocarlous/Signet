...
- **Phishing Prevention**: We will never ask for your private keys or passwords. Always verify that you are on an official domain (`signet.vercel.app`) before interacting with our services.
...
2. Email your findings to: `security@signet.vercel.app`
...
- **Security Issues**: `security@signet.vercel.app`
- **General Support**: `support@signet.vercel.app`
