...
```bash
# Stellar
signet schema --chain=stellar --action=create --json-file=schema.json --key-file=stellar-key.json

# Solana  
signet schema --chain=solana --action=create --json-file=schema.json --key-file=solana-key.json

# Starknet
signet schema --chain=starknet --action=create --json-file=schema.json --key-file=starknet-key.json
```
