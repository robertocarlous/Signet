/**
 * Core types and abstractions for Signet SDKs
 ...
 */
export type SignetProtocolResponse<T = undefined> =
  | {
      data: T
      error?: undefined
    }
 ...
 */
export enum SignetProtocolErrorType {
 ...
 */
export interface SignetProtocolError {
  type: SignetProtocolErrorType
  message: string
  details?: any
  code?: string | number
}
 ...
 */
export function createSuccessResponse<T>(data: T): SignetProtocolResponse<T> {
  return { data }
}
 ...
 */
export function createErrorResponse(error: any): SignetProtocolResponse<never> {
  return { error }
}
 ...
 */
export function createSignetProtocolError(
  type: SignetProtocolErrorType,
  message: string,
  details?: any,
  code?: string | number
