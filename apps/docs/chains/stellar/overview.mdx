...
description: 'SignetProtocol Stellar contract implementation using Soroban smart contracts with native Rust architecture'
---
...
The SignetProtocol Stellar contract leverages Soroban smart contracts to provide efficient attestation services with deterministic storage keys and native Stellar integration.

---

## Contract Architecture

SignetProtocol on Stellar consists of two main Soroban smart contracts:
...
<CardGroup cols={2}>
  <Card
    ...
    href="/monad/overview"
  >
    Compare with the primary, actively-developed EVM port — passkey personhood, EIP-712 delegation
  </Card>
  <Card
    title="Contract Source"
    icon="github"
    href="https://github.com/robertocarlous/Signet/tree/main/contracts/stellar"
  >
  ...
  <Card
    title="Solana (dev)"
    icon="github"
    href="https://github.com/robertocarlous/Signet/tree/main/contracts/solana"
  >
    Early-stage Anchor-based port — no docs yet, browse the source directly
  </Card>
</CardGroup>